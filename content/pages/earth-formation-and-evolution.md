...
[Related links](#links) are listed below the table. Lecture notes are provided by {{% resource_link "5b034dc5-c991-424c-b894-040e2d999509" "WHOI" %}} and link away from OCW. Select lecture slides are available.
...
{{% resource_link "534cf09f-d1a0-4eb3-b50c-89b75b58370e" "Lecture 7 Notes (PDF - 3.6MB)" %}}
...
{{< tdclose >}}
{{< tdopen >}}
{{% resource_link "8a27d3bc-cbcf-4792-9583-bafd2b8acee1" "Lecture 8 Notes (PDF)" %}}
{{< tdclose >}}
...
{{< tdclose >}}
{{< tdopen >}}
{{% resource_link "baf6dc3e-a63f-4b2b-8729-b179b9606c64" "Lecture 9 Notes (PDF)" %}}
{{< tdclose >}}
...
{{< tdclose >}}
{{< tdopen >}}
{{% resource_link "a4189908-49ff-4626-a8b2-49971bef3b7b" "Lecture 10 Notes (PDF)" %}}
{{< tdclose >}}
...
{{< tdclose >}}
{{< tdopen >}}
{{% resource_link "6df657c2-632f-4f3c-827a-01aed5c2fac0" "Lecture 11 Notes (PDF)" %}}
{{< tdclose >}}
...
*   {{% resource_link "d3e99547-ef5e-47f0-a6f1-d22155608437" "CosmoCalc Website" %}}  
    An Excel Spreadsheet add-in for cosmogenic production rates in time/space including instructions and documentation.

*   {{% resource_link "7e53e9a0-95eb-4a8f-a614-cee7ee8036fc" "Moon-forming impact" %}}  
...
*   {{% resource_link "0486e559-3e8e-4445-8e35-ea94f1bad36a" "14 billion years ago" %}}  
